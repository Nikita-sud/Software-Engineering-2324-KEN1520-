...
public class DataStorage {
    ...
    /**
     * Adds or updates patient data in the storage. If the patient does not exist,
     * a new Patient object is created and added to the storage. Otherwise, the new data
     * is added to the existing patient's records.
     *
